        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 10:
                _context.next = 12;
                return _this.form.post("/api/departments/".concat(_this.selectedId, "/update"), {
                  transformRequest: [function (data, headers) {
                    return (0,object_to_formdata__WEBPACK_IMPORTED_MODULE_6__.serialize)(data);
                  }]
                });
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                _this2.$store.commit("department/REMOVE_DEPARTMENT", _this2.selectedId);
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return _this4.hasPermisssion("department-list");

            case 2:
              _this4.loadDepartments();
    ...
    [
      _c("div", { staticClass: "page-header d-print-none" }, [
        _c("div", { staticClass: "row align-items-center" }, [
          ...
          _vm._v(" "),
          _vm.checkPermission("department-create")
      ...
      _c(
        ...
        [
          _vm.departments && _vm.departments.length
            ? _vm._l(_vm.departments, function(department) {
                return _c(
                  "div",
                  {
                    ...
                    class:
                      " " +
                      (_vm.departments.length <= 3
                        ? "col-lg-4 col-md-3 col-sm-6 "
                        : "col-lg-4 col-xl-3 col-sm-6") +
                      " "
                  },
                  [
                    _c("div", { staticClass: "card " }, [
                      _c("div", {
                        ...
                        style: {
                          backgroundImage: "url(" + department.image_url + ")"
                        }
                      }),
                      _vm._v(" "),
                      _c("div", { staticClass: "card-body" }, [
                        _c(
                          ...
                          [
                            ...
                            _vm._v(" "),
                            _vm.checkPermission("department-delete") ||
                            _vm.checkPermission("department-edit")
                              ? _c("div", [
                                  _vm.checkPermission("department-edit")
                                    ? _c(
                                        "span",
                                        {
                                          ...
                                          on: {
                                            click: function($event) {
                                              return _vm.editData(department)
                                            }
                                          }
                                        },
                                        [_c("icon-edit")],
            ...
            : _c(
                ...
                [_c("NotFound", { attrs: { word: "department" } })],
                1
              )
        ],
        2
                        ...
                        _c("div", { staticClass: "modal-header" }, [
                          !_vm.isEditMode
                            ? _c("h5", { staticClass: "modal-title" }, [
                                _vm._v(
                                  "\n                            " +
                                    _vm._s(_vm.$t("create_department")) +
                                    "\n                        "
                                )
                              ])
                            : _c("h5", { staticClass: "modal-title" }, [
                                _vm._v(
                                  "\n                            " +
                                    _vm._s(_vm.$t("update_department")) +
                                    "\n                        "
                                )
                              ]),
                          _vm._v(" "),
                                    ...
                                    _c("base-label", {
                                      attrs: {
                                        title: !_vm.isEditMode
                                          ? _vm.$t("image")
                                          : _vm.$t("change_image"),
                                        required: !_vm.isEditMode ? false : true
                                      }
                                    }),
                                    _vm._v(" "),
                                    _c("input", {
