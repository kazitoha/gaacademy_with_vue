...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  created: function created() {
    var hasPermission = this.$store.getters['rolepermission/userHasPermission']('user-create');
  ...
  methods: {
    userSave: function userSave() {
      ...
      this.userForm.post('/api/users').then(function (response) {
    ...
    onImageChange: function onImageChange(e) {
      ...
      reader.onload = function () {
        _this2.userForm.image = reader.result;
      };
  ...
  computed: {
    roles: function roles() {
      console.log(this.$store.getters['role/roles']);
