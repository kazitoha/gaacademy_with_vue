(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_pages_admin_calendar_index_vue"],{
...
var ListEventRenderer = /** @class */ (function (_super) {
    ...
    ListEventRenderer.prototype.renderSegHtml = function (seg) {
        ...
        var timeHtml;
        if (eventDef.allDay) {
            timeHtml = (0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.getAllDayHtml)(options);
        }
        else if ((0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.isMultiDayRange)(eventRange.range)) {
            if (seg.isStart) {
                timeHtml = (0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.htmlEscape)(this._getTimeText(eventInstance.range.start, seg.end, false // allDay
                ));
            }
            else if (seg.isEnd) {
                timeHtml = (0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.htmlEscape)(this._getTimeText(seg.start, eventInstance.range.end, false // allDay
                ));
            }
            ...
            timeHtml = (0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.htmlEscape)(this.getTimeText(eventRange));
        }
        if (url) {
        ...
        return '<tr class="' + classes.join(' ') + '">' +
            ...
            '<a' + (url ? ' href="' + (0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.htmlEscape)(url) + '"' : '') + '>' +
...
var ListView = /** @class */ (function (_super) {
    ...
    function ListView(viewSpec, parentEl) {
        ...
        _this.computeDateVars = (0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.memoize)(computeDateVars);
        _this.eventStoreToSegs = (0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.memoize)(_this._eventStoreToSegs);
        _this.renderSkeleton = (0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.memoizeRendering)(_this._renderSkeleton, _this._unrenderSkeleton);
        var eventRenderer = _this.eventRenderer = new ListEventRenderer(_this);
        _this.renderContent = (0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.memoizeRendering)(eventRenderer.renderSegs.bind(eventRenderer), eventRenderer.unrender.bind(eventRenderer), [_this.renderSkeleton]);
        return _this;
    }
    ...
    ListView.prototype._eventStoreToSegs = function (eventStore, eventUiBases, dayRanges) {
        return this.eventRangesToSegs((0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.sliceEventStore)(eventStore, eventUiBases, this.props.dateProfile.activeRange, this.context.nextDayThreshold).fg, dayRanges);
    };
    ...
    ListView.prototype.eventRangeToSegs = function (eventRange, dayRanges) {
        ...
        for (dayIndex = 0; dayIndex < dayRanges.length; dayIndex++) {
            segRange = (0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.intersectRanges)(range, dayRanges[dayIndex]);
            if (segRange) {
                seg = {
                    component: this,
    ...
    ListView.prototype.renderEmptyMessage = function () {
        this.contentEl.innerHTML =
            '<div class="fc-list-empty-wrap2">' + // TODO: try less wraps
                ...
                (0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.htmlEscape)(this.context.options.noEventsMessage) +
                '</div>' +
                '</div>' +
                '</div>';
    };
    ...
    ListView.prototype.renderSegList = function (allSegs) {
        ...
        var daySegs;
        var i;
        var tableEl = (0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.htmlToElement)('<table class="fc-list-table ' + theme.getClass('tableList') + '"><tbody></tbody></table>');
    ...
    ListView.prototype.buildDayHeaderRow = function (dayDate) {
        var _a = this.context, theme = _a.theme, dateEnv = _a.dateEnv, options = _a.options;
        var mainFormat = (0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.createFormatter)(options.listDayFormat); // TODO: cache
        var altFormat = (0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.createFormatter)(options.listDayAltFormat); // TODO: cache
        return (0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.createElement)('tr', {
            className: 'fc-list-heading',
            'data-date': dateEnv.formatIso(dayDate, { omitTime: true })
        }, '<td class="' + (theme.getClass('tableListHeading') ||
            theme.getClass('widgetHeader')) + '" colspan="3">' +
            (mainFormat ?
                (0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.buildGotoAnchorHtml)(options, dateEnv, dayDate, { 'class': 'fc-list-heading-main' }, (0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.htmlEscape)(dateEnv.format(dayDate, mainFormat)) // inner HTML
                ) :
                '') +
            (altFormat ?
                (0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.buildGotoAnchorHtml)(options, dateEnv, dayDate, { 'class': 'fc-list-heading-alt' }, (0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.htmlEscape)(dateEnv.format(dayDate, altFormat)) // inner HTML
                ) :
                '') +
            '</td>');
    };
...
function computeDateVars(dateProfile) {
    ...
    while (dayStart < viewEnd) {
        ...
        dayRanges.push({
            start: dayStart,
            end: (0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.addDays)(dayStart, 1)
        });
        dayStart = (0,_fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.addDays)(dayStart, 1);
    }
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "AbstractTimeGridView": () => (/* binding */ AbstractTimeGridView),
/* harmony export */   "TimeGrid": () => (/* binding */ TimeGrid),
/* harmony export */   "TimeGridSlicer": () => (/* binding */ TimeGridSlicer),
/* harmony export */   "TimeGridView": () => (/* binding */ TimeGridView),
/* harmony export */   "buildDayRanges": () => (/* binding */ buildDayRanges),
/* harmony export */   "buildDayTable": () => (/* binding */ buildDayTable)
/* harmony export */ });
/* harmony import */ var _fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @fullcalendar/core */ "./node_modules/@fullcalendar/core/main.esm.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (FullCalendarComponent);
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/admin/calendar/index.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/admin/calendar/index.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      selectedId: "",
      calendarPlugins: [_fullcalendar_daygrid__WEBPACK_IMPORTED_MODULE_5__.default, _fullcalendar_interaction__WEBPACK_IMPORTED_MODULE_8__.default, _fullcalendar_timegrid__WEBPACK_IMPORTED_MODULE_6__.default, _fullcalendar_list__WEBPACK_IMPORTED_MODULE_7__.default]
    };
  },
  methods: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _this.form.post("/api/calendars");
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                if (!_this2.checkPermission("calendar-edit")) {
                  _context2.next = 15;
                  break;
                }
                ...
                _context2.prev = 1;
                _context2.next = 4;
                return _this2.form.put("/api/calendars/".concat(_this2.selectedId));

              case 4:
                response = _context2.sent;
                _this2.isEditModalShow = false;
              ...
              case 15:
                _this2.toastError("You do not have permission to update this event.");
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                if (!_this3.checkPermission("calendar-delete")) {
                  _context3.next = 15;
                  break;
                }
              ...
              case 15:
                _this3.toastError("You do not have permission to delete this event.");
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return _this4.$store.dispatch("calendar/fetchEvents");
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return _this5.hasPermisssion("calendar-list");

            case 2:
              _this5.$store.dispatch("calendar/fetchEvents");
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/@fullcalendar/core/main.css":
/*!****************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/@fullcalendar/core/main.css ***!
  \****************************************************************************************************************************/
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/@fullcalendar/daygrid/main.css":
/*!*******************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/@fullcalendar/daygrid/main.css ***!
  \*******************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/admin/calendar/index.vue?vue&type=style&index=0&lang=css&":
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/admin/calendar/index.vue?vue&type=style&index=0&lang=css& ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../../node_modules/css-loader/dist/runtime/api.js */ "./node_modules/css-loader/dist/runtime/api.js");
/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_fullcalendar_core_main_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! -!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../../../node_modules/@fullcalendar/core/main.css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/@fullcalendar/core/main.css");
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_fullcalendar_daygrid_main_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! -!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../../../node_modules/@fullcalendar/daygrid/main.css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/@fullcalendar/daygrid/main.css");
// Imports



var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
___CSS_LOADER_EXPORT___.i(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_fullcalendar_core_main_css__WEBPACK_IMPORTED_MODULE_1__.default);
___CSS_LOADER_EXPORT___.i(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_fullcalendar_daygrid_main_css__WEBPACK_IMPORTED_MODULE_2__.default);
// Module
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _index_vue_vue_type_template_id_c6ad142c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=c6ad142c& */ "./resources/js/pages/admin/calendar/index.vue?vue&type=template&id=c6ad142c&");
/* harmony import */ var _index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js& */ "./resources/js/pages/admin/calendar/index.vue?vue&type=script&lang=js&");
/* harmony import */ var _index_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&lang=css& */ "./resources/js/pages/admin/calendar/index.vue?vue&type=style&index=0&lang=css&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__.default)(
  ...
  _index_vue_vue_type_template_id_c6ad142c___WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_c6ad142c___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/pages/admin/calendar/index.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/pages/admin/calendar/index.vue?vue&type=script&lang=js&":
/*!******************************************************************************!*\
  !*** ./resources/js/pages/admin/calendar/index.vue?vue&type=script&lang=js& ***!
  \******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/admin/calendar/index.vue?vue&type=script&lang=js&");
...
/***/ "./resources/js/pages/admin/calendar/index.vue?vue&type=style&index=0&lang=css&":
/*!**************************************************************************************!*\
  !*** ./resources/js/pages/admin/calendar/index.vue?vue&type=style&index=0&lang=css& ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/pages/admin/calendar/index.vue?vue&type=template&id=c6ad142c&":
/*!************************************************************************************!*\
  !*** ./resources/js/pages/admin/calendar/index.vue?vue&type=template&id=c6ad142c& ***!
  \************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_c6ad142c___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_c6ad142c___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_c6ad142c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=c6ad142c& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/admin/calendar/index.vue?vue&type=template&id=c6ad142c&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/admin/calendar/index.vue?vue&type=template&id=c6ad142c&":
/*!***************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/admin/calendar/index.vue?vue&type=template&id=c6ad142c& ***!
  \***************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    [
        ...
        _c("div", { staticClass: "row align-items-center" }, [
          _c("div", { staticClass: "col" }, [
            ...
            _c("h2", { staticClass: "page-pretitle" }, [
              _vm._v(_vm._s(_vm.$t("announcement")))
            ])
          ]),
          _vm._v(" "),
          _vm.checkPermission("calendar-create")
      ...
      _c("div", { staticClass: "col-12" }, [
        _c("div", { staticClass: "alert alert-primary" }, [
          _vm._v(
            "\n            " +
              _vm._s(_vm.$t("click_the_event_to_edit_or_delete")) +
              "\n        "
          )
        ])
      ]),
      ...
      _c("div", { staticClass: "card" }, [
        _c("div", { staticClass: "card-header" }, [
          _vm._v(_vm._s(_vm.$t("event_calendar")))
        ]),
        _vm._v(" "),
        _c(
          "div",
                      ...
                      [
                        ...
                        _c("div", { staticClass: "modal-header" }, [
                          _c("h5", { staticClass: "modal-title" }, [
                            _vm._v(_vm._s(_vm.$t("create_event")))
                          ]),
                          _vm._v(" "),
                          _c("button", {
                            staticClass: "btn-close",
                            ...
                            _c("div", { staticClass: "modal-body py-4" }, [
                                ...
                                _c(
                                  ...
                                  [
                                    _c("label", { staticClass: "form-label" }, [
                                      _vm._v(_vm._s(_vm.$t("event_title")))
                                    ]),
                                    _vm._v(" "),
                                    _c("input", {
                                      directives: [
                                      ...
                                      attrs: {
                                        type: "text",
                                        placeholder: _vm.$t("enter_event_title")
                                      },
                              ...
                              _c("div", { staticClass: "row mb-3" }, [
                                _c(
                                  ...
                                  [
                                    _c("label", { staticClass: "form-label" }, [
                                      _vm._v(_vm._s(_vm.$t("starting_date")))
                                    ]),
                                    _vm._v(" "),
                                    _c("date-picker", {
                                      attrs: {
                                ...
                                _c(
                                  ...
                                  [
                                    _c("label", { staticClass: "form-label" }, [
                                      _vm._v(_vm._s(_vm.$t("ending_date")))
                                    ]),
                                    _vm._v(" "),
                                    _c("date-picker", {
                                      attrs: {
                  ...
                  [
                    _c(
                        ...
                        directives: [
                          {
                            name: "on-clickaway",
                            rawName: "v-on-clickaway",
                            value: _vm.toggleEditModal,
                            expression: "toggleEditModal"
                          }
                        ],
                        staticClass: "modal-content"
                      },
                      [
                        _c("div", { staticClass: "modal-header" }, [
                          _c("h5", { staticClass: "modal-title" }, [
                            _vm._v(_vm._s(_vm.$t("edit_event")))
                          ]),
                          _vm._v(" "),
                          _c("button", {
                            staticClass: "btn-close",
                        ...
                        _c(
                          ...
                          [
                            ...
                            _c(
                              ...
                              { staticClass: "modal-footer" },
                              [
                                _vm.checkPermission("calendar-delete")
                                  ? _c(
                                      "button",
                                      {
                                        staticClass: "btn btn-danger me-auto",
                                        attrs: { type: "button" },
                                  ...
                                  : _vm._e(),
                                _vm._v(" "),
                                _vm.checkPermission("calendar-edit")
                                  ? [
                                      _vm.form.busy
                                        ? _c("button-loading")
                                        : _c(
