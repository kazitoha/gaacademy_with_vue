...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm.checkPermission("routine-list") ||
      ...
      _vm.checkPermission("syllabus-list") ||
            ...
            [
              ...
              _vm.checkPermission("session-list")
                ? _c(
                    ...
                    {
                      staticClass: "dropdown-item",
                      class: { active: _vm.checkRoute("academic-session") },
              ...
              _vm.checkPermission("department-list")
                ? _c(
                    ...
                    {
                      staticClass: "dropdown-item",
                      class: { active: _vm.checkRoute("department") },
              ...
              _vm.checkPermission("class-room-list")
                ? _c(
                    ...
                    {
                      staticClass: "dropdown-item",
                      class: { active: _vm.checkRoute("academic-classroom") },
              ...
              _vm.checkPermission("class-list")
                ? _c(
                    ...
                    {
                      staticClass: "dropdown-item",
                      class: { active: _vm.checkRoute("academic-class") },
              ...
              _vm.checkPermission("section-list")
                ? _c(
                    ...
                    {
                      staticClass: "dropdown-item",
                      class: { active: _vm.checkRoute("academic-section") },
              ...
              _vm.checkPermission("subject-list")
                ? _c(
                    ...
                    {
                      staticClass: "dropdown-item",
                      class: { active: _vm.checkRoute("academic-subject") },
            ...
            [
              ...
              _vm.checkPermission("exam-list")
                ? _c(
                    ...
                    {
                      staticClass: "dropdown-item",
                      class: { active: _vm.checkRoute(["exam"]) },
                      attrs: { to: { name: "exam" } }
                    },
                    [
                      _vm._v(
              ...
              _vm.checkPermission("exam-mark-list")
                ? _c(
                    ...
                    {
                      staticClass: "dropdown-item",
                      class: { active: _vm.checkRoute("exam-mark") },
              ...
              _vm.checkPermission("exam-rule-list")
                ? _c(
                    ...
                    {
                      staticClass: "dropdown-item",
                      class: { active: _vm.checkRoute("exam-result-rule") },
              ...
              _vm.checkPermission("exam-result-list")
                ? _c(
                    ...
                    {
                      staticClass: "dropdown-item",
                      class: { active: _vm.checkRoute("exam-result") },
              ...
              _vm.checkPermission("promotion-list")
                ? _c(
                    ...
                    {
                      staticClass: "dropdown-item",
                      class: { active: _vm.checkRoute("promotion") },
            ...
            [
              ...
              _vm.checkPermission("student-report")
                ? _c(
                    ...
                    {
                      staticClass: "dropdown-item",
                      class: { active: _vm.checkRoute("report-student") },
              ...
              _vm.checkPermission("teacher-report")
                ? _c(
                    ...
                    {
                      staticClass: "dropdown-item",
                      class: { active: _vm.checkRoute("report-teacher") },
              ...
              _vm.checkPermission("staff-report")
                ? _c(
                    ...
                    {
                      staticClass: "dropdown-item",
                      class: { active: _vm.checkRoute("report-staff") },
              ...
              _vm.checkPermission("class-routine-report")
                ? _c(
                    ...
                    {
                      staticClass: "dropdown-item",
                      class: { active: _vm.checkRoute("report-class-routine") },
              ...
              _vm.checkPermission("exam-schedule-report")
                ? _c(
                    ...
                    {
                      staticClass: "dropdown-item",
                      class: { active: _vm.checkRoute("report-exam-routine") },
            ...
            [
              ...
              _vm.checkPermission("message-notification-send")
                ? _c(
                    ...
                    {
                      staticClass: "dropdown-item",
                      class: { active: _vm.checkRoute("message") },
              ...
              _vm.checkPermission("calendar-list")
                ? _c(
                    ...
                    {
                      staticClass: "dropdown-item",
                      class: { active: _vm.checkRoute("calendar") },
            ...
            [
              ...
              _vm.checkPermission("fee-type-list")
                ? _c(
                    ...
                    {
                      staticClass: "dropdown-item",
                      class: { active: _vm.checkRoute("fees-type") },
              ...
              _vm.checkPermission("expense-type-list")
                ? _c(
                    ...
                    {
                      staticClass: "dropdown-item",
                      class: { active: _vm.checkRoute("expense-type") },
                      attrs: { to: { name: "expense-type" } }
                    },
                    [
                      _vm._v(
                        "\n            " +
              ...
              _vm.checkPermission("expense-list")
                ? _c(
                    ...
                    {
                      staticClass: "dropdown-item",
                      class: { active: _vm.checkRoute("expense-expense-list") },
                      attrs: { to: { name: "expense-expense-list" } }
                    },
                    [
                      _vm._v(
                        "\n            " +
      ...
      _c(
        "li",
        { staticClass: "nav-item", attrs: { "setting-list": "" } },
        [
          _vm.checkPermission("role-list")
            ? _c(
                ...
                {
                  staticClass: "nav-link",
                  class: { active: _vm.checkRoute("role") },
                  attrs: { to: { name: "role" } }
                },
                [
                  _c(
        ...
        [
          _vm.checkPermission("role-list")
            ? _c(
                ...
                {
                  staticClass: "nav-link",
                  class: { active: _vm.checkRoute("List") },
                  attrs: { to: { name: "List" } }
                },
                [
                  _c(
      ...
      _c(
        ...
        { staticClass: "nav-item" },
        [
          _vm.checkPermission("setting-list")
            ? _c(
                "router-link",
                {
                  staticClass: "nav-link",
      ...
      _vm.user.original_role === "Accountant"
        ...
        : _vm._e(),
      _vm._v(" "),
      _c("li", { staticClass: "text-center mt-3" }, [_c("Clock")], 1)
    ],
    1
  )
}
